...
// tests for ApiResponseListAttendance
void main() {
  // final instance = ApiResponseListAttendance();

  group('test ApiResponseListAttendance', () {
    ...
    // Response data
    // List<Attendance> data (default value: const [])
