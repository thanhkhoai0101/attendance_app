...
// tests for ApiResponseListUserResponse
void main() {
  // final instance = ApiResponseListUserResponse();

  group('test ApiResponseListUserResponse', () {
    ...
    // Response data
    // List<UserResponse> data (default value: const [])
